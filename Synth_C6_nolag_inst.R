...
cols<-ncol(data)
  ...
  load("C:/Users/Teich/Desktop/Data diplomka/Cat_6/Synth_C6_nolag_inst_results.RData")
  pairs<- c("CZE_DEU","CZE_SVK","CZE_POL","CZE_ITA","CZE_AUT","CZE_FRA","CZE_GBR","CZE_HUN","CZE_NLD","CZE_BEL")
  destinations<-c("Germany","Slovakia","Poland","Italy","Austria","France","United Kingdom","Hungary","Netherlands","Belgium")
