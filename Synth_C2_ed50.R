...
data <- read.dta13("C:/Users/Teich/Desktop/Data diplomka/Cat_2/Category_2.dta")
cols<-ncol(data)
rows<-nrow(data)
...
load("C:/Users/Teich/Desktop/Data diplomka/Cat_2/Synth_C2_ed50_results.RData")
pairs<- c("CZE_DEU","CZE_AUT","CZE_POL","CZE_ITA","CZE_SVK","CZE_FRA")
