...
data <- read.dta13("C:/Users/T_doma/Desktop/Data diplomka/Cat_4/Category_4.dta")
cols<-ncol(data)
  rows<-nrow(data)
  ...
  treat<- "CZE_BGR"
  control_origins<-c("SVK","HUN","SVN","POL","ROM","HRV","LTU")
  control_destinations<-c("BGR","ROM","POL","HUN","GRC","HRV","SVN","SVK","LTU")
  conditions_1 <-eval(parse(text=paste("data[,2]=='", control_origins,"'",sep="", collapse=" | ")))
  conditions_2 <-eval(parse(text=paste("data[,3]=='", control_destinations,"'",sep="", collapse=" | ")))
  control_num<- length(control_origins)*length(control_destinations)
  controls<-unique(data[conditions_1 & conditions_2,1])
  ...
  load("C:/Users/Teich/Desktop/Data diplomka/Cat_4/Synth_C4_nolag_inst_results.RData")
  pairs<- c("CZE_POL","CZE_SVK","CZE_AUT","CZE_DEU","CZE_HUN","CZE_BGR","CZE_ITA")
  destinations<-c("Poland","Slovakia","Austria","Germany","Hungary","Bulgaria","Italy")
