...
data <- read.dta13("C:/Users/Teich/Desktop/Data diplomka/Cat_6/Category_6.dta")
cols<-ncol(data)
rows<-nrow(data)
...
load("C:/Users/Teich/Desktop/Data diplomka/Cat_6/Synth_C6_ed50_results.RData")
pairs<- c("CZE_DEU","CZE_SVK","CZE_POL","CZE_ITA","CZE_AUT","CZE_FRA","CZE_GBR","CZE_HUN","CZE_NLD","CZE_BEL")
