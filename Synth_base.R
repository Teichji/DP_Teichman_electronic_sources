...
library(readstata13)
 ...
 #   abline(v=which(unique(data[,1]) == "2013Q3"), col="black")
 # }
  cbind(eval(parse(text=(paste("gap_plot_",j,"_",model_version,".pdf",sep=""))))) 
  paste("gap_plot_",0,"_",model_version,".pdf",sep="")
  
  load("C:/Users/Teich/Desktop/Data diplomka/Total/Synth_base_results.RData")
