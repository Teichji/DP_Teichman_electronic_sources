...
data <- read.dta13("C:/Users/Teich/Desktop/Data diplomka/Cat_4/Category_4.dta")
cols<-ncol(data)
rows<-nrow(data)
...
load("C:/Users/Teich/Desktop/Data diplomka/Cat_4/Synth_C4_ed50_results.RData")
pairs<- c("CZE_POL","CZE_SVK","CZE_AUT","CZE_DEU","CZE_HUN","CZE_BGR","CZE_ITA")
