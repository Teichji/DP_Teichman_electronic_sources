...
data <- read.dta13("C:/Users/Teich/Desktop/Data diplomka/Cat_9/Category_9.dta")
cols<-ncol(data)
  rows<-nrow(data)
  ...
  load("C:/Users/Teich/Desktop/Data diplomka/Cat_9/Synth_C9_nolag_inst_results.RData")
  pairs <- c("CZE_DEU","CZE_SVK","CZE_POL","CZE_ITA","CZE_AUT")
  destinations<-c("Germany","Slovakia", "Poland","Italy","Austria")
