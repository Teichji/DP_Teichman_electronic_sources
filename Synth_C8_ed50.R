...
data <- read.dta13("C:/Users/Teich/Desktop/Data diplomka/Cat_8/Category_8.dta")
cols<-ncol(data)
rows<-nrow(data)
...
load("C:/Users/Teich/Desktop/Data diplomka/Cat_8/Synth_C8_ed50_results.RData")
pairs <- c("CZE_DEU","CZE_SVK","CZE_AUT","CZE_GBR","CZE_FRA","CZE_POL","CZE_ITA","CZE_NLD","CZE_BEL")
