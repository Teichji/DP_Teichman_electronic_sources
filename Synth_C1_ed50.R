...
data <- read.dta13("C:/Users/Teich/Desktop/Data diplomka/Cat_1/Category_1.dta")
cols<-ncol(data)
rows<-nrow(data)
...
load("C:/Users/Teich/Desktop/Data diplomka/Cat_1/Synth_C1_ed50_results.RData")
pairs<- c("CZE_SVK","CZE_ITA","CZE_DEU","CZE_POL","CZE_GBR","CZE_HUN","CZE_FRA","CZE_SWE","CZE_AUT","CZE_BEL")
