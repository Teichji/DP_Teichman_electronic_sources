...
data <- read.dta13("C:/Users/Teich/Desktop/Data diplomka/Cat_0/Category_0.dta")
cols<-ncol(data)
rows<-nrow(data)
...
load("C:/Users/Teich/Desktop/Data diplomka/Cat_0/Synth_C0_ed50_results.RData")
pairs<- c("CZE_SVK","CZE_DEU","CZE_POL","CZE_AUT","CZE_HUN","CZE_ITA","CZE_GBR","CZE_FRA","CZE_ROM","CZE_NLD")
destinations<-c("Slovakia", "Germany", "Poland", "Austria", "Hungary","Italy","United Kingdom","France", "Romania","Netherlands")
