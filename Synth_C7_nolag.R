...
cols<-ncol(data)
  ...
  pred<-c(which(colnames(data) == "Dist"),which(colnames(data) == "GDP_o"),which(colnames(data) == "GDP_d"),which(colnames(data) == "GPD_PC_o"),which(colnames(data) == "GPD_PC_d"),which(colnames(data) == "Population_o"),which(colnames(data) == "Population_d"),which(colnames(data) == "RER"),which(colnames(data) == "Rem_o"),which(colnames(data) == "Rem_d"),which(colnames(data) == "contig"),which(colnames(data) == "comcur"))
  dep<-cols
  time<-4
  unit_name <- 1
  unit_num<-(cols+1)
  ...
  load("C:/Users/Teich/Desktop/Data diplomka/Cat_7/Synth_C7_nolag_results.RData")
