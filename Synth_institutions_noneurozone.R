...
library(readstata13)
  ...
  data <- read.dta13("C:/Users/Teich/Desktop/Data diplomka/Total/Total_noneurozone.dta")
  cols<-ncol(data)
  rows<-nrow(data)
...
#  }
  ...
  load("C:/Users/Teich/Desktop/Data diplomka/Total/Synth_institutions_noneurozone_results.RData")
  ticks<-seq(from = 4,by=8,length.out=6)
  axis<- c("2005Q4","2007Q4","2009Q4","2011Q4","2013Q4","2015Q4")
  model_version<-"institutions_noneu"
