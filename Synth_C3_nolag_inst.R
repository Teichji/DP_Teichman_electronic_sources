...
data <- read.dta13("C:/Users/T_doma/Desktop/Data diplomka/Cat_3/Category_3.dta")
cols<-ncol(data)
  rows<-nrow(data)
  ...
  load("C:/Users/Teich/Desktop/Data diplomka/Cat_3/Synth_C3_results.RData")
  pairs<- c("CZE_DEU","CZE_SVK","CZE_AUT","CZE_POL","CZE_HUN")
  destinations<-c("Germany","Slovakia","Austria","Poland","Hungary")
