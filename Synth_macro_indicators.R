...
library(readstata13)
  ...
  pred<-c(which(colnames(data) == "GDP"),which(colnames(data) == "Population"),which(colnames(data) == "FMA"),which(colnames(data) == "Country_risk"),which(colnames(data) == "Labor_index"),which(colnames(data) == "FDI_share"),which(colnames(data) == "RER"),which(colnames(data) == "HICP"),which(colnames(data) == "Unemployment"))
...
#  }
  ...
  load("C:/Users/Teich/Desktop/Data diplomka/Total/Synth_macro_indicators_results.RData")
